        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.section}>
                ...
                <TouchableOpacity style={styles.sectionItem} onPress={() => navigation.navigate('ChangePassword')}>
                    <Icon name="lock" style={styles.icon} size={20} color="#4A90E2" />
                    <Text style={styles.text}>Đổi mật khẩu</Text>
                    <Icon name="chevron-right" style={styles.chevron} size={16} color="#B0B0B0" />
                </TouchableOpacity>
                <TouchableOpacity style={styles.sectionItem} onPress={() => navigation.navigate('Login')}>
                    <Icon name="sign-out" style={styles.icon} size={20} color="#4A90E2" />
